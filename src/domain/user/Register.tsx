...
import {
  ...
  RegisterContainer,
  FormSection,
} from '@/domain/user/styles/register.styled'
import { useNavigate } from 'react-router-dom'
import { useRegisterForm } from '@/domain/user/hooks/useRegisterForm'
import { LoginContainer } from '@/domain/user/styles/login.styled'
